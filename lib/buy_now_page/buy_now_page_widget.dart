                                ...
                                children: [
                                  ...
                                  Text(
                                    valueOrDefault<String>(
                                      functions
                                          .daysDiff(datePicked1, datePicked2)
                                          .toString(),
                                      '0',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  valueOrDefault<String>(
                                    functions
                                        .dateDiffCal(datePicked1, datePicked2,
                                            widget.price)
                                        .toString(),
                                    '0',
                                  ),
                                ...
                                if (widget.price ==
                                  ...
                                  final confirmBookingCreateData =
                                    ...
                                    totalAmt: functions.dateDiffCal(
                                        datePicked1, datePicked2, widget.price),
                                    ...
                                    fromdate:
                                        functions.isDatePicked(datePicked1),
                                    todate: functions.isDatePicked(datePicked2),
                                    utrNo: '0123456789',
                                  ...
                                  final notificationsCreateData =
                                    ...
                                    uid: functions.autoIncrementUid(
                                        FFAppState().autoUid.toString()),
                                    regtime: getCurrentTimestamp,
                                    msg: functions.paymentNotificationToOwner(
                                        functions.dateDiffCal(datePicked1,
                                            datePicked2, widget.price),
                                        currentUserDisplayName,
                                        functions.daysDiff(
                                            datePicked1, datePicked2),
                                        buyNowPageUploadParkingRecord.regby),
                                    notificationtype: 'payment success',
                                    regemailid: currentUserEmail,
                                    isUserShown: false,
                                    targetEmailid: buyNowPageUploadParkingRecord
                                        .regbyEmailId,
                                    totalAmt: functions.dateDiffCal(
                                        datePicked1, datePicked2, widget.price),
                                  );
